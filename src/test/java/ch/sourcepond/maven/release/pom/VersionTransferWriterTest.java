...
public class VersionTransferWriterTest {
	private static final String[] EXPECTED_VERSIONS = new String[] { "1.1938382293932932.3002923834838284",
	...
	public void setup() throws Exception {
		try (final InputStream in = getClass().getResourceAsStream("/version-transfer/original.pom")) {
			copyInputStreamToFile(in, originalPom);
		}

		// originalPom.deleteOnExit();
		writer = new VersionTransferWriter(originalPom);
	...
	private void verifyUpdatedVersion(final String originalLine, final String updatedLine,
